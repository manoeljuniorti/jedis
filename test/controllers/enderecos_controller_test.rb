...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { address: @endereco.address, cep: @endereco.cep, city: @endereco.city, complement: @endereco.complement, district: @endereco.district, ibge_cod: @endereco.ibge_cod, state: @endereco.state } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { address: @endereco.address, cep: @endereco.cep, city: @endereco.city, complement: @endereco.complement, district: @endereco.district, ibge_cod: @endereco.ibge_cod, state: @endereco.state } }
