...
class MunicipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipe" do
    assert_difference('Municipe.count') do
      post municipes_url, params: { municipe: { birth_date: @municipe.birth_date, cns: @municipe.cns, cpf: @municipe.cpf, email: @municipe.email, name: @municipe.name, phone: @municipe.phone, photo: @municipe.photo, status: @municipe.status } }
    end
  ...
  test "should update municipe" do
    patch municipe_url(@municipe), params: { municipe: { birth_date: @municipe.birth_date, cns: @municipe.cns, cpf: @municipe.cpf, email: @municipe.email, name: @municipe.name, phone: @municipe.phone, photo: @municipe.photo, status: @municipe.status } }
